...
public class MushAudioManager : MonoBehaviour
{
    public static MushAudioManager Instance;
    ...
    private void Start()
    {
        audioSource = FindAnyObjectByType<MushStateManager>().GetComponent<AudioSource>();
